...
public class FurnishBlocks {
	...
	public static final RegistrySupplier<Block> Oak_Wardrobe = registerBlockWithItem("oak_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Oak_Crate = registerBlockWithItem("oak_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Oak_Bookshelf_Chest = registerBlockWithItem("oak_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Birch_Wardrobe = registerBlockWithItem("birch_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Birch_Crate = registerBlockWithItem("birch_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Birch_Bookshelf_Chest = registerBlockWithItem("birch_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.BIRCH_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Acacia_Wardrobe = registerBlockWithItem("acacia_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Acacia_Crate = registerBlockWithItem("acacia_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Acacia_Bookshelf_Chest = registerBlockWithItem("acacia_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.ACACIA_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Jungle_Wardrobe = registerBlockWithItem("jungle_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Jungle_Crate = registerBlockWithItem("jungle_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Jungle_Bookshelf_Chest = registerBlockWithItem("jungle_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.JUNGLE_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Spruce_Wardrobe = registerBlockWithItem("spruce_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Spruce_Cabinet_Open_Sound, FurnishRegistries.Spruce_Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Spruce_Crate = registerBlockWithItem("spruce_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Spruce_Bookshelf_Chest = registerBlockWithItem("spruce_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.SPRUCE_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Dark_Oak_Wardrobe = registerBlockWithItem("dark_oak_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Spruce_Cabinet_Open_Sound, FurnishRegistries.Spruce_Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Dark_Oak_Crate = registerBlockWithItem("dark_oak_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Dark_Oak_Bookshelf_Chest = registerBlockWithItem("dark_oak_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.DARK_OAK_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Crimson_Wardrobe = registerBlockWithItem("crimson_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Crimson_Crate = registerBlockWithItem("crimson_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Crimson_Bookshelf_Chest = registerBlockWithItem("crimson_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.CRIMSON_PLANKS).pushReaction(PushReaction.BLOCK)));
	...
	public static final RegistrySupplier<Block> Warped_Wardrobe = registerBlockWithItem("warped_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	...
	public static final RegistrySupplier<Block> Warped_Crate = registerBlockWithItem("warped_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	...
	public static final RegistrySupplier<Block> Warped_Bookshelf_Chest = registerBlockWithItem("warped_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.WARPED_PLANKS).pushReaction(PushReaction.BLOCK)));

	public static final RegistrySupplier<Block> Cherry_Table = registerBlockWithItem("cherry_table", () -> new Table(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS)));
	public static final RegistrySupplier<Block> Cherry_Square_Table = registerBlockWithItem("cherry_square_table", () -> new SimpleFurniture(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS)));
	public static final RegistrySupplier<Block> Cherry_Pedestal_Table = registerBlockWithItem("cherry_pedestal_table", () -> new SimpleFurniture(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), false));
	public static final RegistrySupplier<Block> Cherry_Bedside_Table = registerBlockWithItem("cherry_bedside_table", () -> new InventoryFurniture(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), FurnishRegistries.Drawers_Open_Sound, FurnishRegistries.Drawers_Close_Sound));
	public static final RegistrySupplier<Block> Cherry_Kitchen_Cabinet = registerBlockWithItem("cherry_kitchen_cabinet", () -> new InventoryFurniture(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), FurnishRegistries.Drawers_Open_Sound, FurnishRegistries.Drawers_Close_Sound));
	public static final RegistrySupplier<Block> Cherry_Cabinet = registerBlockWithItem("cherry_cabinet", () -> new Cabinet(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	public static final RegistrySupplier<Block> Cherry_Wardrobe = registerBlockWithItem("cherry_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	public static final RegistrySupplier<Block> Cherry_Stool = registerBlockWithItem("cherry_stool", () -> new Chair(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), Chair.BASE_SHAPES));
	public static final RegistrySupplier<Block> Cherry_Chair = registerBlockWithItem("cherry_chair", () -> new Chair(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS), VoxelShapeHelper.getMergedShapes(Chair.BASE_SHAPES, Chair.CHAIR_SEAT)));
	public static final RegistrySupplier<Block> Cherry_Shutter = registerBlockWithItem("cherry_shutter", () -> new Shutter(BlockBehaviour.Properties.copy(Blocks.CHERRY_TRAPDOOR)));
	public static final RegistrySupplier<Block> Cherry_Crate = registerBlockWithItem("cherry_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	public static final RegistrySupplier<Block> Cherry_Shelf = registerBlockWithItem("cherry_shelf", () -> new Shelf(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS)));
	public static final RegistrySupplier<Block> Cherry_Bench = registerBlockWithItem("cherry_bench", () -> new Bench(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS)));
	public static final RegistrySupplier<Block> Cherry_Log_Bench = registerBlockWithItem("cherry_log_bench", () -> new LogBench(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS)));
	...
	public static final RegistrySupplier<Block> Cherry_Bookshelf_Chest = registerBlockWithItem("cherry_bookshelf_chest", () -> new BookshelfChest(BlockBehaviour.Properties.copy(Blocks.CHERRY_PLANKS).pushReaction(PushReaction.BLOCK)));

	public static final RegistrySupplier<Block> Mangrove_Table = registerBlockWithItem("mangrove_table", () -> new Table(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS)));
	public static final RegistrySupplier<Block> Mangrove_Square_Table = registerBlockWithItem("mangrove_square_table", () -> new SimpleFurniture(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS)));
	public static final RegistrySupplier<Block> Mangrove_Pedestal_Table = registerBlockWithItem("mangrove_pedestal_table", () -> new SimpleFurniture(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), false));
	public static final RegistrySupplier<Block> Mangrove_Bedside_Table = registerBlockWithItem("mangrove_bedside_table", () -> new InventoryFurniture(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), FurnishRegistries.Drawers_Open_Sound, FurnishRegistries.Drawers_Close_Sound));
	public static final RegistrySupplier<Block> Mangrove_Kitchen_Cabinet = registerBlockWithItem("mangrove_kitchen_cabinet", () -> new InventoryFurniture(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), FurnishRegistries.Drawers_Open_Sound, FurnishRegistries.Drawers_Close_Sound));
	public static final RegistrySupplier<Block> Mangrove_Cabinet = registerBlockWithItem("mangrove_cabinet", () -> new Cabinet(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	public static final RegistrySupplier<Block> Mangrove_Wardrobe = registerBlockWithItem("mangrove_wardrobe", () -> new Wardrobe(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).pushReaction(PushReaction.BLOCK), FurnishRegistries.Cabinet_Open_Sound, FurnishRegistries.Cabinet_Close_Sound));
	public static final RegistrySupplier<Block> Mangrove_Stool = registerBlockWithItem("mangrove_stool", () -> new Chair(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), Chair.BASE_SHAPES));
	public static final RegistrySupplier<Block> Mangrove_Chair = registerBlockWithItem("mangrove_chair", () -> new Chair(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS), VoxelShapeHelper.getMergedShapes(Chair.BASE_SHAPES, Chair.CHAIR_SEAT)));
	public static final RegistrySupplier<Block> Mangrove_Shutter = registerBlockWithItem("mangrove_shutter", () -> new Shutter(BlockBehaviour.Properties.copy(Blocks.MANGROVE_TRAPDOOR)));
	public static final RegistrySupplier<Block> Mangrove_Crate = registerBlockWithItem("mangrove_crate", () -> new Crate(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS).pushReaction(PushReaction.DESTROY)), new Item.Properties().stacksTo(1));
	public static final RegistrySupplier<Block> Mangrove_Shelf = registerBlockWithItem("mangrove_shelf", () -> new Shelf(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS)));
	public static final RegistrySupplier<Block> Mangrove_Bench = registerBlockWithItem("mangrove_bench", () -> new Bench(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS)));
	public static final RegistrySupplier<Block> Mangrove_Log_Bench = registerBlockWithItem("mangrove_log_bench", () -> new LogBench(BlockBehaviour.Properties.copy(Blocks.MANGROVE_PLANKS)));
	...
	static {
		...
		for(DyeColor dyeColor : DyeColor.values()) {
			...
			Block coloredCarpet = BuiltInRegistries.BLOCK.get(new ResourceLocation(String.format("minecraft:%s_carpet", color)));
			...
			Block coloredWool = BuiltInRegistries.BLOCK.get(new ResourceLocation(String.format("minecraft:%s_wool", color)));
			...
			Block coloredTerracotta = BuiltInRegistries.BLOCK.get(new ResourceLocation(String.format("minecraft:%s_terracotta", color)));
