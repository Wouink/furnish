...
public class DiskRackScreen extends ContainerScreen<DiskRackContainer> {
	...
	public DiskRackScreen(DiskRackContainer p_i51105_1_, PlayerInventory p_i51105_2_, ITextComponent p_i51105_3_) {
