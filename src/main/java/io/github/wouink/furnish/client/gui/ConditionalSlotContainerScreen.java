...
public class ConditionalSlotContainerScreen extends ContainerScreen<ConditionalSlotContainer> {
	private static final ResourceLocation CONTAINER_BACKGROUND = new ResourceLocation("textures/gui/container/generic_54.png");
	private final int containerRows;

	public ConditionalSlotContainerScreen(ConditionalSlotContainer p_i51095_1_, PlayerInventory p_i51095_2_, ITextComponent p_i51095_3_) {
